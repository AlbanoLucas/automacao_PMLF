    ...
    for arquivo in os.listdir(PASTA_PDFS):
        ...
        for parte in partes:
            if any(kw in parte for kw in ["NOMEIA", "NOMEAÇÃO", "EXONERA", "NOMEADO", "NOMEADA", "EXONERADO", "EXONERADA"]):
                if any(skip_kw in parte for skip_kw in ["REGULARIZAR SITUAÇÃO DE ACÚMULO DE CARGO", "RETIFICA", "NOMEIA SERVIDORA COMO", "NOMEIA SERVIDOR COMO", "NOMEIA SERVIDORES COMO"]):
                    continue
